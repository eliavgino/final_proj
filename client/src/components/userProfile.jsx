...
function UserProfile() {
  ...
  <Box className='profileContainer slideIn' sx={{width:{lg:'35vw',xs:'60vw'}}}>
    <Container sx={{position:'relative' ,marginTop:'8vh'}}>
        <Box sx={{pt:'9vh', justifyContent:'center', position:'relative',width:'35vw',height:'80vh',boxShadow:'10',backgroundColor:'rgb(210, 125, 45)'}}>
          <Container sx={{height:'100%',width:'20vw',justifyContent:'center'}}>
            <Avatar sx={{height:'14vh',width:'7vw',marginLeft:'4vw'}}>
            </Avatar>
            <Typography sx={{fontSize:'2vw' ,marginLeft:'3vw' ,mt:'2vh'}}>userProfile</Typography>
            <Box sx={{ml:'-6vw', position:'relative',mt:'8vh',display:'flex', height:'20%',width:'30vw'}}>
